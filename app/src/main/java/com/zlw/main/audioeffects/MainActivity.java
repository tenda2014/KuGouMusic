...
public class MainActivity extends AppCompatActivity {
...

    {
        ...
        MUSIC_DATA.put("rolling_in_the_deep.mp3", UriHelper.getResUri(R.raw.rolling_in_the_deep));
...
//    private AudioView audioView;
    ...
    private MyMediaPlayer.PlayState playStatus;
...
//                @Override
//                public void run() {
//                    if (playStatus == MyMediaPlayer.PlayState.STATE_PLAYING) {
//                        Logger.d(TAG, "当前波形:" + audioVisualConverter.getVoiceSize(waveform));
            ...
            audioView2.post(new Runnable() {
                ...
                public void run() {
                    if (playStatus == MyMediaPlayer.PlayState.STATE_PLAYING) {
                        ...
                        Logger.d(TAG, "当前分贝:" + audioVisualConverter.getVoiceSize(fft));
...
//        audioView.setStyle(AudioView.ShowStyle.STYLE_WAVE, AudioView.ShowStyle.STYLE_WAVE);
        audioView2 = findViewById(R.id.audioView2);
        audioView2.setStyle(AudioView.ShowStyle.STYLE_WAVE, AudioView.ShowStyle.STYLE_NOTHING);
        ...
        tvPause.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (playStatus == MyMediaPlayer.PlayState.STATE_PLAYING) {
                    mediaPlayer.pause();
                } else if (playStatus == MyMediaPlayer.PlayState.STATE_PAUSE) {
                    mediaPlayer.resume();
                }
            }
        });
